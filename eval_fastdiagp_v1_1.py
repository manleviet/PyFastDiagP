...
from algorithms import fastdiagp_v1_1
...
def main():
    if len(sys.argv) > 1:
        ...
        fastdiagp_v1_1.solver_path = sys.argv[3]
        fastdiagp_v1_1.numCores = int(sys.argv[4])
    else:
    ...
    print(in_req_filename + "|" + str(total_time) + "|" + str(fastdiagp_v1_1.checker.counter_CC)
